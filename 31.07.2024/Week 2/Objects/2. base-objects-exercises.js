...
smartphone.brand = `iphone`, smartphone.model = `13 Pro`,smartphone.storageGB = 32
...
let recipe = {
    name: `Pizza`,
    ingredients: [`tomato`,`cheese`,`olives`,`dough`],
    preparationTime: 5,
}
let recipeKeys = Object.keys(recipe)
console.log(recipe[recipeKeys[1]][0]);
...
console.log(country.name = `Israel`,country.capital = `Jeruslam`, country.population += 1000000);
console.log(country);
...
console.log(computer.brand = `ASUS`,computer.CPU = `i7`, computer.RAMinGB += 8*2);
